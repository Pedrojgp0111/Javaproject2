...
public class Runner {
        ...
        while (exit) {
            ...
            switch (option) {
                ...
                case 6:
                    ...
                    break;
                default:
                    System.out.println("Not valid, type another number.");
                    break;
            }
        }
    }
    ...
    public static University initializeUniversity() {
        ...
        myUniversity.addNewTeacherToTeachersList(new FullTimeTeacher("Leonardo", 200, 3));
        myUniversity.addNewTeacherToTeachersList(new PartTimeTeacher("Zamy", 200, 48));
        myUniversity.addNewTeacherToTeachersList(new FullTimeTeacher("Mery", 200, 5));
        myUniversity.addNewTeacherToTeachersList(new PartTimeTeacher("Juliana", 200, 20));

        Student student1 = new Student("Pedro", 23);
        Student student2 = new Student("Juan", 25);
        Student student3 = new Student("Isabella", 21);
        Student student4 = new Student("Celeste", 24);
        Student student5 = new Student("Luz", 23);
        Student student6 = new Student("Catalina", 22);
        ...
        myUniversity.addNewGroupToGroupsList(new Group("Chemistry", 101, list1, myUniversity.getTeachersList().get(0)));
        myUniversity.addNewGroupToGroupsList(new Group("English", 102, list2, myUniversity.getTeachersList().get(1)));
        myUniversity.addNewGroupToGroupsList(new Group("Philosophy", 201, list3, myUniversity.getTeachersList().get(2)));
        myUniversity.addNewGroupToGroupsList(new Group("Spanish", 202, list4, myUniversity.getTeachersList().get(3)));
